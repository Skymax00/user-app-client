export const hi = {
  translation: {
    ...
    ALSO_AVAILABLE_ON: "इस पर भी उपलब्ध",
    ...
    ARIA_BASE_NETWORK: "बेस नेटवर्क",
    ARIA_P2P_TOKEN_HOLDINGS: "P2P टोकन होल्डिंग्स",
    ARIA_REFRESH_BALANCE: "बैलेंस रिफ्रेश करें",
    ...
    BECOME_A_LIQUIDITY_PARTNER: "लिक्विडिटी पार्टनर बनें",
    BECOME_A_LIQUIDITY_PARTNER_SUBTITLE: "रिवॉर्ड कमाएँ",
    BENEFITS_BANNER_CTA: "लाभ देखें",
    BENEFITS_BANNER_DESCRIPTION:
      "साझेदार स्टोर पर QR से भुगतान करें और USDC वापस पाएँ।",
    BENEFITS_BANNER_LABEL: "लाभ",
    BENEFITS_BANNER_TITLE: "{{cashbackPercent}}% तक कैशबैक",
    BOUGHT_VIA: "के माध्यम से खरीदा",
    BRIDGE: "ब्रिज",
    BRIDGE_ADDRESS_PLACEHOLDER: "{{chain}} पता",
    BRIDGE_AMOUNT_COPIED: "राशि कॉपी की गई",
    BRIDGE_CONFIRMING: "पुष्टि हो रही है…",
    ...
    BRIDGE_DIRECTION_DEPOSIT: "जमा",
    BRIDGE_DIRECTION_WITHDRAW: "निकासी",
    BRIDGE_EXPIRED: "समाप्त",
    BRIDGE_GET_QUOTE: "कोट प्राप्त करें",
    BRIDGE_HISTORY_DESCRIPTION:
      "इस डिवाइस पर संग्रहीत हाल के ब्रिज। अपने पूर्ण इतिहास के लिए, NEAR Intents एक्सप्लोरर पर जाएं।",
    BRIDGE_HISTORY_TITLE: "ब्रिज इतिहास",
    ...
    BRIDGE_SELECT_CHAIN: "चेन चुनें",
    BRIDGE_SELECT_TOKEN: "टोकन चुनें",
    BRIDGE_SEND_ONLY_WARNING:
      "इस पते पर केवल <0>{{network}} नेटवर्क पर {{token}} टोकन</0> भेजें। कोई अन्य एसेट या नेटवर्क धनराशि की स्थायी हानि का कारण बनेगा।",
    BRIDGE_SENT_FUNDS: "मैंने धनराशि भेज दी है",
    BRIDGE_SLIPPAGE_DESCRIPTION:
      "यह सेटिंग स्वैप की अपेक्षित कीमत और आपके द्वारा चुकाई जाने वाली वास्तविक कीमत के बीच अधिकतम अनुमेय अंतर निर्धारित करती है, जो हमारे नियंत्रण से बाहर है।",
    BRIDGE_SLIPPAGE_EFFECT: "आपको कोट से <0>{{percent}}</0> तक कम मिल सकता है।",
    BRIDGE_SLIPPAGE_INVALID: "0.01% और 50% के बीच का मान दर्ज करें।",
    BRIDGE_SLIPPAGE_LOSS_INFO:
      "आपके द्वारा निर्धारित {{percent}}% स्लिपेज के आधार पर आपको {{maxLoss}} तक कम मिल सकता है।",
    BRIDGE_SLIPPAGE_TOLERANCE: "स्लिपेज सहनशीलता",
    BRIDGE_SLIPPAGE_WARNING:
      "<0>2% से कम</0> स्लिपेज से आपके स्वैप के असफल होने और रिफंड होने की संभावना बढ़ जाती है। विशेष रूप से बड़ी राशियों के लिए <1>2% या अधिक</1> का उपयोग करने पर विचार करें।",
    BRIDGE_SPENDABLE: "उपलब्ध: {{balance}}",
    BRIDGE_STATUS_FAILED: "विफल",
    ...
    BRIDGE_WITHDRAW_STATUS_KNOWN_DEPOSIT_TX: "USDC भेजा गया",
    BRIDGE_WITHDRAW_STATUS_PENDING_DEPOSIT: "USDC भेजा जा रहा है…",
    ...
    CIRCLE_ADMIN: "सर्कल एडमिन",
    CIRCLE_OPERATOR: "सहायता",
    CLABE_ID: "CLABE नंबर",
    CLAIM: "क्लेम करें",
    ...
    FAQ_HOW_WITHDRAW_FUNDS_ANSWER:
      "आप USDC को निम्न द्वारा निकाल सकते हैं:\n• सीधे Base वॉलेट पते पर भेजकर, या\n• अन्य चेनों में फंड ले जाने के लिए Near Intents के माध्यम से क्रॉस-चेन निकासी का उपयोग करके।",
    ...
    FAQ_WHO_HANDLES_CROSS_CHAIN_ANSWER:
      "सभी क्रॉस-चेन क्रियाएँ Near Intents द्वारा संचालित होती हैं। यदि कोई देरी या समस्याएँ हैं, तो आपको यहाँ Near Intents समर्थन से संपर्क करना होगा।",
    ...
    INVALID_BOOST_CONFIG: "अमान्य बूस्ट कॉन्फ़िगरेशन",
    ...
    LIVENESS_DESCRIPTION: "त्वरित चेहरा जाँच, कोई दस्तावेज़ नहीं",
    LIVENESS_ERROR: "लाइवनेस: {{message}}",
    LIVENESS_SUBMISSION_FAILED: "लाइवनेस सबमिशन विफल",
    LIVENESS_VERIFIED_WITH_REWARD: "लाइवनेस सफलतापूर्वक सत्यापित",
    LIVENESS_VERIFYING: "आपकी लाइवनेस सत्यापित की जा रही है...",
    ...
    MY_STAKE_ACTIVITY_FAILED: "गतिविधि लोड करने में विफल",
    MY_STAKE_ACTIVITY_SEIZED: "स्टेक जब्त",
    ...
    MY_STAKE_BOOST_MAXED_OUT: "बूस्ट अधिकतम पर",
    MY_STAKE_BOOST_MAXED_OUT_BUTTON: "बूस्ट अधिकतम पर",
    MY_STAKE_CLAIM_READY_HEADING: "आपका $P2P दावा करने के लिए तैयार है",
    MY_STAKE_COOLDOWN_ENDS: "कूलडाउन समाप्त",
    MY_STAKE_COOLDOWN_HEADING: "आपका $P2P दावा करने योग्य होगा",
    MY_STAKE_COOLDOWN_TIME_REMAINING: "शेष समय",
    MY_STAKE_MAX_TOPUP_IS: "अधिकतम टॉप-अप {{amount}} $P2P है",
    MY_STAKE_MORE_LIMIT_TO_UNLOCK: "और सीमा अनलॉक करने के लिए",
    MY_STAKE_ORDER_LIMIT_BOOSTED: "ऑर्डर सीमा बढ़ाई गई",
    MY_STAKE_STAKED_LABEL: "मेरा स्टेक",
    MY_STAKE_STAKE_NOW: "अभी स्टेक करें",
    MY_STAKE_STAKE_TO_INCREASE_LIMIT: "ऑर्डर सीमा बढ़ाने के लिए स्टेक करें",
    MY_STAKE_TITLE: "मेरा स्टेक",
    MY_STAKE_TOPUP_BUTTON: "लिमिट बढ़ाने हेतु स्टेक",
    MY_STAKE_TOPUP_CONFIRM: "पुष्टि करें",
    MY_STAKE_TOPUP_DESCRIPTION:
      "उच्च ऑर्डर सीमाओं को अनलॉक करने के लिए अधिक $P2P स्टेक करें।",
    MY_STAKE_TOPUP_TITLE: "$P2P स्टेक करें",
    MY_STAKE_UNSTAKE_BUTTON: "अनस्टेक",
    MY_STAKE_UNSTAKE_DRAWER_TITLE: "अनस्टेक",
    MY_STAKE_UNSTAKE_HEADING: "सभी $P2P अनस्टेक करें?",
    MY_STAKE_UNSTAKE_IF_FLAGGED:
      "यदि ब्लैकलिस्ट किया गया, {{duration}} लॉक · स्टेक जोखिम में",
    MY_STAKE_UNSTAKE_IN_DAYS:
      "{{duration}} के बाद, {{amount}} $P2P अपने वॉलेट में वापस क्लेम करें",
    MY_STAKE_UNSTAKE_RIGHT_NOW:
      "अभी, {{amount}} $P2P {{duration}} के लिए लॉक होगा",
    MY_STAKE_UNSTAKE_WHAT_HAPPENS: "क्या होता है",
    MY_STAKE_UNSTAKE_YOUR_LIMITS: "सीमाएं डिफ़ॉल्ट पर रीसेट होंगी",
    MY_STAKE_UPDATED_UNLOCK_LIMIT: "अद्यतन अनलॉक सीमा",
    ...
    NO_LIQUIDITY_FOR_ORDER:
      "पर्याप्त लिक्विडिटी वाला कोई मर्चेंट नहीं मिला। कृपया छोटा ऑर्डर दें।",
    ...
    NO_STAKE_TO_CLAIM: "दावा करने के लिए कोई स्टेक नहीं है",
    NO_SWAPS_YET: "अभी तक कोई स्वैप नहीं",
    NO_SWAPS_YET_DESC: "आपके पिछले P2P स्वैप यहाँ दिखाई देंगे।",
    ...
    P2P_STAKE_COMPLETED_TITLE: "स्टेक पूरा हुआ",
    P2P_STAKE_CONFIRM_STAKING: "स्टेकिंग",
    P2P_STAKE_CONFIRM_TITLE: "स्टेक की पुष्टि करें",
    ...
    P2P_STAKE_NO_BALANCE_DESCRIPTION:
      "स्टेकिंग शुरू करने के लिए USDC को $P2P में स्वैप करें",
    ...
    P2P_STAKE_SUCCESS: "$P2P सफलतापूर्वक स्टेक किया गया",
    ...
    P2P_STAKE_TITLE: "$P2P स्टेक करें",
    P2P_STAKE_TOKEN_ALREADY_SET: "$P2P स्टेक टोकन पहले से सेट है",
    P2P_STAKE_TOKEN_NOT_SET: "$P2P स्टेक टोकन सेट नहीं है",
    P2P_STAKE_TOTAL_STAKED: "कुल स्टेक",
    P2P_STAKE_UPDATED_TXN_LIMIT: "अपडेटेड लेनदेन सीमा",
    P2P_STAKE_UP_TO_PREFIX: "तक",
    P2P_STAKE_USDC_LIMIT: "USDC सीमा",
    P2P_STAKE_YOUR_NEW_LIMITS: "आपकी नई सीमाएं",
    P2P_STAKE_YOU_UNLOCK_LIMIT: "आप सीमा अनलॉक करते हैं",
    P2P_SWAP: "P2P स्वैप",
    P2P_SWAP_BANNER_DESCRIPTION: "अपने वॉलेट से सीधे, तत्काल स्वैप।",
    P2P_SWAP_BANNER_LABEL: "P2P ↔ USDC",
    P2P_SWAP_BANNER_TITLE: "P2P ⇄ USDC स्वैप करें",
    P2P_SWAP_ERROR_ADDRESS_REQUIRED: "पता आवश्यक है",
    P2P_SWAP_ERROR_AMOUNT_QUERY_PARAM_REQUIRED: "राशि query param आवश्यक है",
    P2P_SWAP_ERROR_APPROVE_INSUFFICIENT_AMOUNT:
      "Approve सफल हुआ लेकिन राशि अपर्याप्त है",
    P2P_SWAP_ERROR_APPROVE_TIMEOUT: "Approve ट्रांजैक्शन timeout हो गया",
    P2P_SWAP_ERROR_APPROVE_TX_FAILED: "Approve ट्रांजैक्शन on-chain विफल",
    P2P_SWAP_ERROR_BRIDGE_FAILED_ON_CHAIN: "Bridge on-chain विफल",
    P2P_SWAP_ERROR_BRIDGE_NO_OUTPUT_AMOUNT: "Bridge ने output राशि नहीं दी",
    P2P_SWAP_ERROR_COMPANY_WALLET_DEPOSIT_NOT_ALLOWED:
      "कंपनी वॉलेट से deposit की अनुमति नहीं है",
    P2P_SWAP_ERROR_DEPOSIT_TX_NOT_CONFIRMED:
      "ट्रांजैक्शन कन्फर्म नहीं हुआ — यह pending हो सकता है या अभी on-chain नहीं है",
    P2P_SWAP_ERROR_DEPOSIT_TX_REVERTED:
      "ट्रांजैक्शन on-chain रिवर्ट हो गया और deposit के रूप में उपयोग नहीं किया जा सकता",
    ...
    P2P_SWAP_ERROR_INVALID_USDC_AMOUNT:
      "अमान्य USDC राशि — base units में होनी चाहिए",
    P2P_SWAP_ERROR_JUP_EXECUTE_FAILED: "DEX स्वैप execute करने में विफल",
    P2P_SWAP_ERROR_JUP_NON_POSITIVE_OUTPUT_DELTA:
      "स्वैप अलग तरह से रूट हो सकता है — output राशि शून्य या नकारात्मक है",
    P2P_SWAP_ERROR_JUP_ORDER_FAILED: "DEX order प्राप्त करने में विफल",
    P2P_SWAP_ERROR_JUP_OUTPUT_BALANCE_NOT_FOUND:
      "कन्फर्म ट्रांजैक्शन में output टोकन बैलेंस नहीं मिला",
    P2P_SWAP_ERROR_JUP_SWAP_DID_NOT_SUCCEED: "DEX स्वैप सफल नहीं हुआ",
    P2P_SWAP_ERROR_JUP_SWAP_NOT_CONFIRMED_TIMEOUT:
      "DEX स्वैप ट्रांजैक्शन timeout के भीतर कन्फर्म नहीं हुआ",
    P2P_SWAP_ERROR_JUP_SWAP_TX_FAILED: "DEX स्वैप ट्रांजैक्शन on-chain विफल",
    P2P_SWAP_ERROR_NO_P2P_TRANSFER_FOUND:
      "deposit पते पर कोई P2P ट्रांसफर नहीं मिला",
    P2P_SWAP_ERROR_NO_RANGO_ROUTE: "इस राशि के लिए कोई रूट नहीं मिला",
    P2P_SWAP_ERROR_NO_USDC_TRANSFER_FOUND:
      "deposit पते पर कोई USDC ट्रांसफर नहीं मिला",
    P2P_SWAP_ERROR_RANGO_BRIDGE_FAILED_ON_RETRY: "Bridge पुनः प्रयास पर विफल",
    P2P_SWAP_ERROR_RANGO_BRIDGE_TIMEOUT:
      "Bridge timeout हो गया — 15 मिनट बाद कोई अंतिम स्थिति नहीं",
    P2P_SWAP_ERROR_RANGO_NO_SERIALIZED_MESSAGE:
      "Bridge ने serialized ट्रांजैक्शन नहीं दिया",
    P2P_SWAP_ERROR_RANGO_QUOTE_FAILED: "Bridge quote विफल",
    P2P_SWAP_ERROR_REFUND_ALREADY_IN_PROGRESS: "रिफंड पहले से प्रक्रिया में है",
    P2P_SWAP_ERROR_REFUND_CREATE_FAILED: "रिफंड रिकॉर्ड बनाने में विफल",
    P2P_SWAP_ERROR_REFUND_QUEUED: "रिफंड कतार में लगा दिया गया है",
    P2P_SWAP_ERROR_REFUND_REQUEST_RAISED: "रिफंड अनुरोध दर्ज किया गया",
    ...
    P2P_SWAP_ERROR_RETRY_ATTEMPTS_NOT_EXHAUSTED:
      "रिफंड जारी करने से पहले सभी पुनः प्रयास समाप्त होने चाहिए। कृपया प्रतीक्षा करें और पुनः प्रयास करें।",
    P2P_SWAP_ERROR_SWAP_ALREADY_REFUNDED: "स्वैप पहले ही रिफंड हो चुका है",
    P2P_SWAP_ERROR_SWAP_NOT_FOUND: "स्वैप नहीं मिला",
    P2P_SWAP_ERROR_SWAP_NOT_IN_FAILED_STATE: "स्वैप विफल स्थिति में नहीं है",
    P2P_SWAP_ERROR_TXN_HASH_AND_USER_ADDRESS_REQUIRED:
      "ट्रांजैक्शन हैश और उपयोगकर्ता पता आवश्यक हैं",
    P2P_SWAP_ERROR_USER_ID_REQUIRED: "उपयोगकर्ता ID आवश्यक है",
    P2P_SWAP_ERROR_VAA_NOT_READY: "इस स्वैप के लिए VAA तैयार नहीं है",
    P2P_SWAP_ERROR_WORMHOLE_INVALID_VAA_ID_FORMAT: "अमान्य VAA ID format",
    P2P_SWAP_ERROR_WORMHOLE_PARSE_FAILED_BASE_TX:
      "Base ट्रांजैक्शन से bridge संदेश parse करने में विफल",
    P2P_SWAP_ERROR_WORMHOLE_PARSE_FAILED_SOLANA_TX:
      "Solana ट्रांजैक्शन से bridge संदेश parse करने में विफल",
    P2P_SWAP_ERROR_WORMHOLE_VAA_TIMEOUT: "VAA timeout के भीतर उपलब्ध नहीं हुआ",
    ...
    P2P_UNSTAKE_REQUEST_SUCCESS: "अनस्टेक का अनुरोध किया गया। कूलडाउन शुरू।",
    P2P_UNSTAKE_STAKED_LABEL: "वर्तमान में स्टेक",
    ...
    PAGO_MOVIL_QR_DETAILS: "Pago Móvil QR",
    ...
    PAYMENT_QR_CHANGE: "QR बदलें",
    PAYMENT_QR_DECODING: "QR पढ़ा जा रहा है…",
    PAYMENT_QR_DETECTED: "QR मिला",
    PAYMENT_QR_FALLBACK_HINT: "अगर वे QR स्कैन न कर सकें तो नीचे विवरण भरें",
    ...
    PAYMENT_QR_REMOVE_HINT: "QR हटाने से नीचे भरे विवरण नहीं मिटते",
    ...
    PC: "पीसी",
    PERPS_BANNER_BEAR: "नुकसान?",
    PERPS_BANNER_BULL: "मुनाफा?",
    PERPS_BANNER_CTA: "Perps ट्रेड करें",
    PERPS_BANNER_DESCRIPTION: "जीतें या हारें, आपको हमेशा 10% कैशबैक मिलता है।",
    PERPS_BANNER_YES: "10% कैशबैक.",
    PERU_CCI_INVALID: "मान्य 20-अंकों का CCI या Yape/Plin फ़ोन (9XXXXXXXX) दर्ज करें",
    PERU_CCI_LABEL: "CCI",
    PERU_CCI_PLACEHOLDER: "CCI (20 अंक)",
    PERU_NO_QR_ENTER_CCI: "QR नहीं है? CCI या फ़ोन दर्ज करें",
    PERU_PHONE_LABEL: "Yape / Plin फ़ोन",
    PERU_PHONE_PLACEHOLDER: "Yape/Plin फ़ोन (9XXXXXXXX)",
    PERU_QR_ACCOUNT: "खाता",
    PERU_QR_CHANGE: "QR बदलें",
    PERU_QR_DECODING: "QR पढ़ा जा रहा है…",
    PERU_QR_DETECTED: "QR मिला",
    PERU_QR_INVALID_QR: "यह मान्य Yape/Plin QR नहीं लगता",
    PERU_QR_READ_ERROR: "वह QR पढ़ा नहीं जा सका — दूसरी छवि आज़माएँ",
    PERU_QR_UPLOAD: "QR अपलोड करें",
    PERU_QR_UPLOAD_HINT: "डिवाइस से QR छवि चुनने के लिए टैप करें",
    PERU_QR_UPLOAD_TITLE: "अपना Yape/Plin QR अपलोड करें",
    PERU_QR_VIEW: "QR देखें",
    PERU_USE_QR_INSTEAD: "Yape/Plin QR इस्तेमाल करें",
    ...
    PLACEHOLDER_ACCOUNT_NUMBER_BOB: "Bank account number (8–20 digits)",
    ...
    PROOF_HELP:
      "व्यापारी (या सर्कल एडमिन) से भुगतान का स्क्रीनशॉट या PDF संलग्न करने के लिए कहें। केवल आप और इस ऑर्डर पर अधिकृत लोग ही इसे खोल सकते हैं — हर बार आपकी ऑन-चेन भूमिका के आधार पर पहुँच जाँची जाती है।",
    PROOF_HELP_TOGGLE: "यह क्या है?",
    PROOF_ONCHAIN_EXPLORER: "ब्लॉक एक्सप्लोरर",
    PROOF_ONCHAIN_HELP:
      "यह ऑर्डर ऑन-चेन निपटा: व्यापारी ने सीधे आपके प्राप्ति पते पर USDC भेजा। ट्रांसफर सत्यापित करने के लिए {{explorer}} पर लेन-देन खोलें — किसी रसीद की आवश्यकता नहीं।",
    PROOF_ONCHAIN_SHORT: "ऑन-चेन निपटान — USDC ट्रांसफर सत्यापित करें",
    PROOF_ONCHAIN_VIEW: "ऑन-चेन देखें",
    PROOF_PENDING: "अनुरोध किया गया — मर्चेंट की प्रतीक्षा है",
    PROOF_READY: "आपकी भुगतान रसीद देखने के लिए तैयार है",
    PROOF_REQUEST: "प्रमाण का अनुरोध करें",
    PROOF_REQUESTED: "भुगतान प्रमाण का अनुरोध किया गया",
    PROOF_REQUESTING: "अनुरोध किया जा रहा है…",
    PROOF_REQUEST_FAILED: "भुगतान प्रमाण का अनुरोध नहीं किया जा सका",
    PROOF_SHORT: "भुगतान रसीद — केवल आप इसे खोल सकते हैं",
    PROOF_TITLE: "भुगतान प्रमाण",
    PROOF_UPLOADED: "प्रमाण अपलोड किया गया",
    PROOF_VIEW: "रसीद देखें",
    ...
    QR_SIMPLE: "QR Simple",
    QR_SIMPLE_DETAILS: "QR Simple विवरण",
    ...
    RECOVER_CONNECT_FAILED:
      "उस कुंजी से किसी वॉलेट से कनेक्ट नहीं हो सका। कृपया निजी कुंजी जांचें और पुनः प्रयास करें।",
    RECOVER_ENTER_PRIVATE_KEY: "अपने वॉलेट की निजी कुंजी दर्ज करें",
    RECOVER_FIND_FUNDS: "फंड खोजें",
    RECOVER_FUNDS: "फंड पुनर्प्राप्त करें",
    RECOVER_INVALID_PRIVATE_KEY:
      "अमान्य निजी कुंजी। यह 0x के बाद 64 हेक्स अक्षर होनी चाहिए।",
    RECOVER_PRIVATE_KEY_WARNING:
      "अपनी निजी कुंजी कभी साझा न करें। इसे केवल फंड पुनर्प्राप्त करने के लिए यहां पेस्ट करें, फिर उन्हें किसी अन्य P2P.me वॉलेट में ले जाएं।",
    RECOVER_WALLET: "फंड पुनर्प्राप्त करें",
    RECOVER_WALLET_ADDRESS: "स्मार्ट वॉलेट पता",
    RECOVER_WALLET_WITH_PRIVATE_KEY: "निजी कुंजी से वॉलेट पुनर्प्राप्त करें",
    ...
    SEND_P2P_BASE_ONLY_WARNING:
      "केवल Base नेटवर्क पतों पर भेजें। अन्य नेटवर्क पर भेजने से फंड स्थायी रूप से खो जाएंगे।",
    ...
    STAKE_COOLDOWN_ALREADY_EXTENDED: "स्टेक कूलडाउन पहले ही बढ़ाया जा चुका है",
    ...
    STAKE_EXCEEDS_MAX_TOKENS: "स्टेक अधिकतम अनुमत टोकन से अधिक है",
    STAKE_NOT_ACTIVE: "कोई सक्रिय स्टेक नहीं है",
    STAKE_NOT_IN_COOLDOWN: "स्टेक कूलडाउन अवधि में नहीं है",
    STAKE_SEIZED: "आपका स्टेक जब्त कर लिया गया है",
    STAKE_STATUS_ACTIVE: "सक्रिय",
    ...
    TO_DATE: "अंतिम तारीख",
    TRADE_ON_SOLANA: "Solana पर ट्रेड करें",
    ...
    TRANSFERMOVIL_DETAILS: "Transfermóvil विवरण",
    ...
    UNSTAKE_COOLDOWN_ACTIVE: "अनस्टेक कूलडाउन अवधि अभी भी सक्रिय है",
    ...
    USE_CREDITS_ON_LOTPOT: "अपने क्रेडिट lotpot.fun पर उपयोग करें",
    ...
    VEN_QR_CHANGE: "QR बदलें",
    VEN_QR_CONFIRM: "पुष्टि करें कि यह आपका Pago Móvil QR है",
    VEN_QR_DECODING: "QR पढ़ा जा रहा है…",
    VEN_QR_DETECTED: "QR मिला",
    VEN_QR_INVALID_QR: "यह मान्य Pago Móvil QR नहीं लगता",
    VEN_QR_READ_ERROR: "वह QR पढ़ा नहीं जा सका — दूसरी छवि आज़माएँ",
    VEN_QR_UPLOAD: "QR अपलोड करें",
    VEN_QR_UPLOAD_HINT: "बैंक ऐप से QR चुनने के लिए टैप करें",
    ...
    YOUR_P2P_ON_BASE: "बेस पर आपका $P2P",
