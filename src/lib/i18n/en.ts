export const en = {
  translation: {
    ...
    BRIDGE_AMOUNT_COPIED: "Amount copied",
    BRIDGE_CONFIRMING: "Confirming…",
    ...
    BRIDGE_DIRECTION_WITHDRAW: "Withdraw",
    BRIDGE_EXPIRED: "Expired",
    BRIDGE_GET_QUOTE: "Get a Quote",
    BRIDGE_HISTORY_DESCRIPTION:
      "Recent bridges stored on this device. For your complete history, visit the NEAR Intents explorer.",
    BRIDGE_HISTORY_TITLE: "Bridge History",
    ...
    BRIDGE_SELECT_CHAIN: "Select chain",
    BRIDGE_SELECT_TOKEN: "Select token",
    BRIDGE_SEND_ONLY_WARNING:
      "Send only <0>{{token}} token on the {{network}} network</0> to this address. Any other asset or network will result in permanent loss of funds.",
    ...
    BRIDGE_SLIPPAGE_TOLERANCE: "Slippage tolerance",
    BRIDGE_SLIPPAGE_WARNING:
      "Slippage <0>under 2%</0> increases the chance your swap will be unsuccessful and refunded. Consider using <1>2% or higher</1>, especially for larger amounts.",
    BRIDGE_SPENDABLE: "Spendable: {{balance}}",
    BRIDGE_STATUS_FAILED: "Failed",
    ...
    BRIDGE_WITHDRAW_STATUS_KNOWN_DEPOSIT_TX: "USDC sent",
    BRIDGE_WITHDRAW_STATUS_PENDING_DEPOSIT: "Sending USDC…",
    ...
    DAILY_SELL_ORDER_PLACEMENT_LIMIT_EXCEEDED:
      "Daily sell/pay order placement limit exceeded",
    ...
    GOAT_CASH_BANNER_DESCRIPTION:
      "Earn 10 P2P tokens every week using Scan & Pay on GOAT.CASH.",
    GOAT_CASH_BANNER_LABEL: "New",
    GOAT_CASH_BANNER_REWARD: "+10 P2P / week",
    ...
    INVALID_BOOST_CONFIG: "Invalid boost configuration",
    ...
    LIQUIDITY: "Liquidity",
    LIVENESS_DESCRIPTION: "Quick face check, no documents",
    LIVENESS_ERROR: "Liveness: {{message}}",
    LIVENESS_SUBMISSION_FAILED: "Liveness submission failed",
    LIVENESS_VERIFIED_WITH_REWARD: "Liveness verified successfully",
    LIVENESS_VERIFYING: "Verifying your liveness...",
    LOADING: "Loading",
    ...
    MY_STAKE_ACTIVITY_FAILED: "Failed to load activity",
    MY_STAKE_ACTIVITY_SEIZED: "Stake seized",
    ...
    MY_STAKE_BOOST_MAXED_OUT: "Boost maxed out",
    MY_STAKE_BOOST_MAXED_OUT_BUTTON: "Boost Maxed Out",
    MY_STAKE_CLAIM_READY_HEADING: "Your $P2P is ready to claim",
    MY_STAKE_COOLDOWN_ENDS: "Cooldown ends",
    MY_STAKE_COOLDOWN_HEADING: "Your $P2P will be claimable in",
    MY_STAKE_COOLDOWN_TIME_REMAINING: "Time Remaining",
    MY_STAKE_MAX_TOPUP_IS: "Max top-up is {{amount}} $P2P",
    MY_STAKE_MORE_LIMIT_TO_UNLOCK: "more limit to unlock",
    MY_STAKE_ORDER_LIMIT_BOOSTED: "Order Limit Boosted",
    MY_STAKE_STAKED_LABEL: "My Stake",
    MY_STAKE_STAKE_NOW: "Stake Now",
    MY_STAKE_STAKE_TO_INCREASE_LIMIT: "Stake to increase order limit",
    MY_STAKE_TITLE: "My Stake",
    MY_STAKE_TOPUP_BUTTON: "Stake to Increase Limit",
    MY_STAKE_TOPUP_CONFIRM: "Confirm",
    ...
    MY_STAKE_UNSTAKE_HEADING: "Unstake all $P2P?",
    MY_STAKE_UNSTAKE_IF_FLAGGED:
      "If blacklisted, {{duration}} lock · stake at risk",
    MY_STAKE_UNSTAKE_IN_DAYS:
      "After {{duration}}, Claim {{amount}} $P2P back in your wallet",
    ...
    MY_STAKE_UPDATED_UNLOCK_LIMIT: "Updated Unlock Limit",
    MY_STAKE_YOUR_ORDER_LIMIT: "Your Order Limit",
    NAME: "Name",
    ...
    NO_STAKE_TO_CLAIM: "No stake to claim",
    ...
    P2P_STAKE_COOLDOWN_TO_UNSTAKE: "{{duration}} cooldown to unstake",
    P2P_STAKE_FRAUD_WARNING_DESCRIPTION:
      "Proven fraud will result in your stake being seized.",
    P2P_STAKE_FRAUD_WARNING_TITLE: "Fraud will be punished",
    P2P_STAKE_HEADING_HIGHLIGHT: "Order Limits",
    ...
    P2P_STAKE_TAGLINE: "The more $P2P you stake, the bigger each order can be.",
    P2P_STAKE_TITLE: "Stake $P2P",
    P2P_STAKE_TOKEN_ALREADY_SET: "$P2P stake token is already set",
    P2P_STAKE_TOKEN_NOT_SET: "$P2P stake token is not set",
    P2P_STAKE_TOTAL_STAKED: "Total Staked",
    P2P_STAKE_UPDATED_TXN_LIMIT: "Updated Txn limit",
    P2P_STAKE_UP_TO_PREFIX: "Up to",
    P2P_STAKE_USDC_LIMIT: "USDC limit",
    P2P_STAKE_YOUR_NEW_LIMITS: "Your New Limits",
    P2P_STAKE_YOU_UNLOCK_LIMIT: "You Unlock Limit",
    P2P_SWAP: "P2P Swap",
    ...
    P2P_UNSTAKE_COOLDOWN_REMAINING: "Time remaining",
    P2P_UNSTAKE_DESCRIPTION:
      "Requesting an unstake starts a cooldown period. After the cooldown ends, you can claim your $P2P back to your wallet.",
    P2P_UNSTAKE_NO_STAKE: "You don't have any active stake to unstake.",
    P2P_UNSTAKE_READY_TO_CLAIM: "Ready to claim",
    P2P_UNSTAKE_REQUESTING: "Requesting...",
    P2P_UNSTAKE_REQUEST_BUTTON: "Request unstake",
    P2P_UNSTAKE_REQUEST_SUCCESS: "Unstake requested. Cooldown started.",
    P2P_UNSTAKE_STAKED_LABEL: "Currently staked",
    ...
    PERU_CCI_INVALID:
      "Enter a valid 20-digit CCI or Yape/Plin phone (9XXXXXXXX)",
    PERU_CCI_LABEL: "CCI",
    PERU_CCI_PLACEHOLDER: "CCI (20 digits)",
    PERU_NO_QR_ENTER_CCI: "Don't have a QR? Enter CCI or phone",
    PERU_PHONE_LABEL: "Yape / Plin phone",
    PERU_PHONE_PLACEHOLDER: "Yape/Plin phone (9XXXXXXXX)",
    PERU_QR_ACCOUNT: "Account",
    ...
    PERU_QR_UPLOAD_TITLE: "Upload your Yape/Plin QR",
    PERU_QR_VIEW: "View QR",
    PERU_USE_QR_INSTEAD: "Use Yape/Plin QR instead",
    ...
    PROOF_BADGE_REQUESTED: "Proof requested",
    PROOF_BADGE_UPLOADED: "Proof ready",
    PROOF_DESCRIPTION:
      "Ask the merchant to attach an encrypted receipt for this order.",
    PROOF_DOWNLOAD: "Download",
    PROOF_DOWNLOAD_FAILED: "Download failed",
    PROOF_FILES_TITLE: "Payment proofs",
    PROOF_HELP:
    ...
    PROOF_HELP_TOGGLE: "What is this?",
    PROOF_ONCHAIN_EXPLORER: "the block explorer",
    PROOF_ONCHAIN_HELP:
    ...
    PROOF_ONCHAIN_SHORT: "Settled on-chain — verify the USDC transfer",
    PROOF_ONCHAIN_VIEW: "View on-chain",
    PROOF_PENDING: "Requested — waiting for the merchant",
    PROOF_READY: "Your payment proof is ready to view",
    PROOF_REQUEST: "Request proof",
    PROOF_REQUESTED: "Payment proof requested",
    PROOF_REQUESTING: "Requesting…",
    PROOF_REQUEST_FAILED: "Couldn't request payment proof",
    PROOF_SHORT: "Payment receipt — only you can open it",
    ...
    STAKE_AMOUNT_ZERO: "Stake amount must be greater than zero",
    STAKE_COOLDOWN_ALREADY_EXTENDED: "Stake cooldown has already been extended",
    ...
    STAKE_EXCEEDS_MAX_TOKENS: "Stake exceeds the maximum allowed tokens",
    STAKE_NOT_ACTIVE: "No active stake",
    STAKE_NOT_IN_COOLDOWN: "Stake is not in cooldown",
    STAKE_SEIZED: "Your stake has been seized",
    STAKE_STATUS_ACTIVE: "Active",
    STAKE_STATUS_COOLDOWN: "Cooldown",
    STAKE_STATUS_SEIZED: "Seized",
    ...
    UNSTAKE_COOLDOWN_ACTIVE: "Unstake cooldown is still active",
    ...
    USER_NOT_BLACKLISTED_FOR_EXTENSION: "User is not blacklisted for extension",
    USER_YEARLY_VOLUME_LIMIT_EXCEEDED: "User yearly volume limit exceeded",
    USE_CBBTC_ON_COINSME: "Use your cbBTC on coins.me",
    USE_CREDITS_ON_LOTPOT: "Use your credits on lotpot.fun",
